  ...
  <div id="centerRight2">
    <div class="bg-color-black">
      ...
      <div class="d-flex ai-center flex-column body-box">
        ...
        <dv-active-ring-chart :config="configTwo"  style="width:330px; height:300px;margin-top: -60px;" v-bind:key="configTwo.data[0].value"/>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  async mounted(){
    ...
    this.$set(this.config,"data",res.data.pricelist)
    this.$set(this.configTwo,"data",res.data.pricelist)
  },
  components: { }
}
</script>
