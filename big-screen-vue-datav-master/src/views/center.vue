<template>
  <div id="center">
    <div class="up">
      ...
      >
        <p class="ml-3 colorBlue fw-b fs-xl">车辆总数量</p>
        <div style="color: #7ad0e0; font-size: 24px; font-weight: bold; margin-left: 16px; margin-top: 8px;">
      ...
      <div
        class="bg-color-black item"
      >
        <p class="ml-3 colorBlue fw-b fs-xl">车辆销售最高额</p>
        <div style="color: #7ad0e0; font-size: 24px; font-weight: bold; margin-left: 16px; margin-top: 8px;">
    ...
    <div class="down">
      ...
      <div class="percent">
        ...
        <div class="water" style="font-size: 14px;text-align: center">
          <p>其他类型占有率</p>
...
export default {
  ...
  async mounted(){
    ...
    this.$set(this.ranking,'data',res.data.brandslist)
